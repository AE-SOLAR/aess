...
const Footer = () => {
  return (
    <div className={styles.footerContainer}>
      {/* Фоновые изображения */}
      <img src={productLeft} alt="Product Left" className={styles.footerBackgroundLeft} />
      <img src={productRight} alt="Product Right" className={styles.footerBackgroundRight} />
      ...
      <div className={styles.footerContent}>
        ...
        <div className={styles.leftSection}>
          ...
          <p className={styles.companyInfo}>
            German brand in the renewable energy industry, providing high-quality products
            and services since 2003.
          </p>
          <p className={styles.companyInfo}>
            AE Alternative Energy GMBH<br />
        ...
        <div className={styles.linkGroups}>
          <div className={styles.linkGroup}>
            ...
            <a href="#" className={styles.link}>Aurora</a>
            <a href="#" className={styles.link}>Meteor</a>
            <a href="#" className={styles.link}>Comet</a>
            <a href="#" className={styles.link}>Terra</a>
            <a href="#" className={styles.link}>Shadestar</a>
            <a href="#" className={styles.link}>Neptune</a>
          </div>
          <div className={styles.linkGroup}>
            <h4 className={styles.linkGroupTitle}>About Us</h4>
            <a href="#" className={styles.link}>Company</a>
            <a href="#" className={styles.link}>Manufacturer</a>
            <a href="#" className={styles.link}>B2B Solutions</a>
          ...
          <div className={styles.linkGroup}>
            ...
            <a href="#" className={styles.link}>Imprint</a>
            <a href="#" className={styles.link}>Publisher's</a>
          </div>
          <div className={styles.linkGroup}>
            <h4 className={styles.linkGroupTitle}>Documents</h4>
            <a href="#" className={styles.link}>Datasheet</a>
            <a href="#" className={styles.link}>Warranty</a>
          </div>
        </div>
      </div>
      ...
      <div className={styles.footerBottom}>
        ...
        <div className={styles.footerBottomLinks}>
          ...
          <a href="#" className={styles.link}>Legal</a>
        </div>
      </div>
    </div>
  );
