...
export const HeroHighlight = ({ children, className, containerClassName }) => {
  ...
  return (
    <div
      className={cn(
        "absolute h-[100] flex bg-black dark:bg-black justify-center w-full group",
        containerClassName
      )}
    ...
    >
      ...
      <motion.div
        className="pointer-events-none bg-dot-thick-red-800 dark:bg-dot-thick-red-800 absolute inset-0 opacity-0 transition duration-300 group-hover:opacity-100"
        style={{
