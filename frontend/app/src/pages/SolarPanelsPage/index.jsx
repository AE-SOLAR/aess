...
import HeaderHero from "../../components/HederHero";
...
const SolarPanelsPage = () => {
  ...
  return (
    <>
      <HeaderHero
        imageURL={"/static/images/panels/panel-flower.png"}
        onHeader={true}
      >
          ...
          <div className="grid grid-cols-[repeat(auto-fit,_minmax(250px,_1fr))] px-[10px] text-center gap-[5px] w-full">
            {panels.length > 0 ? (
              panels
                ...
                .filter(
                  (e) =>
                    designsFilter.includes(e.design) ||
                ...
                .filter((e) =>
                  lowerPowerFilter
                    ? parseInt(e.powerRange.split("-")[0], 10) >=
                      lowerPowerFilter
                    : true
                )
                .filter((e) =>
